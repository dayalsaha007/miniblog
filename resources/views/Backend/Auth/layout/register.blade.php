    ...
    <div class="container">
        <form class="form" method="POST" action="{{ route('register') }}">
            ...
            <div class="form__group">
                <input type="name" name="name" class="form__input" placeholder="Name" id="name" required>
            ...
            <div class="form__group">
                <input type="password_confirmation" name="password_confirmation" class="form__input"
